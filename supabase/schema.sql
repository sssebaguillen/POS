...
CREATE OR REPLACE FUNCTION "public"."upsert_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_price_list_id" "uuid", "p_product_id" "uuid", "p_brand_id" "uuid", "p_multiplier" numeric) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'extensions'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."upsert_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_price_list_id" "uuid", "p_product_id" "uuid", "p_brand_id" "uuid", "p_multiplier" numeric) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."delete_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_override_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'extensions'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."delete_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_override_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_customer_stats"("p_business_id" "uuid", "p_from" "date" DEFAULT NULL::"date", "p_to" "date" DEFAULT NULL::"date") RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'extensions'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_customer_stats"("p_business_id" "uuid", "p_from" "date", "p_to" "date") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_customers_list"("p_business_id" "uuid", "p_search" "text" DEFAULT NULL::"text", "p_credit_filter" "text" DEFAULT 'all'::"text", "p_sort" "text" DEFAULT 'name'::"text", "p_limit" integer DEFAULT 50, "p_offset" integer DEFAULT 0) RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'extensions'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_customers_list"("p_business_id" "uuid", "p_search" "text", "p_credit_filter" "text", "p_sort" "text", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_customer_sales"("p_business_id" "uuid", "p_customer_id" "uuid", "p_limit" integer DEFAULT 50, "p_offset" integer DEFAULT 0) RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public', 'extensions'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_customer_sales"("p_business_id" "uuid", "p_customer_id" "uuid", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."audit_log" (
    ...
    CONSTRAINT "audit_log_entity_type_check" CHECK (("entity_type" = ANY (ARRAY['sale'::"text", 'product'::"text", 'category'::"text", 'brand'::"text", 'expense'::"text", 'supplier'::"text", 'price_list'::"text", 'setting'::"text", 'operator'::"text", 'customer'::"text", 'catalog_order'::"text", 'promotion'::"text", 'price_list_override'::"text"])))
);
...
REVOKE ALL ON FUNCTION "public"."upsert_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_price_list_id" "uuid", "p_product_id" "uuid", "p_brand_id" "uuid", "p_multiplier" numeric) FROM PUBLIC;
REVOKE ALL ON FUNCTION "public"."upsert_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_price_list_id" "uuid", "p_product_id" "uuid", "p_brand_id" "uuid", "p_multiplier" numeric) FROM "anon";
GRANT ALL ON FUNCTION "public"."upsert_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_price_list_id" "uuid", "p_product_id" "uuid", "p_brand_id" "uuid", "p_multiplier" numeric) TO "authenticated";
GRANT ALL ON FUNCTION "public"."upsert_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_price_list_id" "uuid", "p_product_id" "uuid", "p_brand_id" "uuid", "p_multiplier" numeric) TO "service_role";


REVOKE ALL ON FUNCTION "public"."delete_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_override_id" "uuid") FROM PUBLIC;
REVOKE ALL ON FUNCTION "public"."delete_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_override_id" "uuid") FROM "anon";
GRANT ALL ON FUNCTION "public"."delete_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_override_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_price_list_override"("p_operator_id" "uuid", "p_business_id" "uuid", "p_override_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_customer_stats"("p_business_id" "uuid", "p_from" "date", "p_to" "date") FROM PUBLIC;
REVOKE ALL ON FUNCTION "public"."get_customer_stats"("p_business_id" "uuid", "p_from" "date", "p_to" "date") FROM "anon";
GRANT ALL ON FUNCTION "public"."get_customer_stats"("p_business_id" "uuid", "p_from" "date", "p_to" "date") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_customer_stats"("p_business_id" "uuid", "p_from" "date", "p_to" "date") TO "service_role";


REVOKE ALL ON FUNCTION "public"."get_customers_list"("p_business_id" "uuid", "p_search" "text", "p_credit_filter" "text", "p_sort" "text", "p_limit" integer, "p_offset" integer) FROM PUBLIC;
REVOKE ALL ON FUNCTION "public"."get_customers_list"("p_business_id" "uuid", "p_search" "text", "p_credit_filter" "text", "p_sort" "text", "p_limit" integer, "p_offset" integer) FROM "anon";
GRANT ALL ON FUNCTION "public"."get_customers_list"("p_business_id" "uuid", "p_search" "text", "p_credit_filter" "text", "p_sort" "text", "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_customers_list"("p_business_id" "uuid", "p_search" "text", "p_credit_filter" "text", "p_sort" "text", "p_limit" integer, "p_offset" integer) TO "service_role";


REVOKE ALL ON FUNCTION "public"."get_customer_sales"("p_business_id" "uuid", "p_customer_id" "uuid", "p_limit" integer, "p_offset" integer) FROM PUBLIC;
REVOKE ALL ON FUNCTION "public"."get_customer_sales"("p_business_id" "uuid", "p_customer_id" "uuid", "p_limit" integer, "p_offset" integer) FROM "anon";
GRANT ALL ON FUNCTION "public"."get_customer_sales"("p_business_id" "uuid", "p_customer_id" "uuid", "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_customer_sales"("p_business_id" "uuid", "p_customer_id" "uuid", "p_limit" integer, "p_offset" integer) TO "service_role";
