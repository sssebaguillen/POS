...
COMMENT ON COLUMN "public"."businesses"."settings" IS 'Configuración del negocio. Keys soportadas: currency (ISO 4217: ARS|USD|EUR|BRL|CLP|UYU|PEN|COP|MXN|PYG|BOB), logo_upload_path (path en storage para logo subido)';
