-- Agrega customer_name a get_sale_detail para que el detalle de venta
-- (POS Historial, Dashboard SalesHistoryTable y el CSV export) muestre
-- a qué cliente se le vendió cuando la venta tiene customer_id asignado.
