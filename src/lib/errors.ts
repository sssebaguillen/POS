...
export const ERR = {
  // EXP — Gastos
  EXP1:  'No se pudo guardar el gasto. Intentá de nuevo. (EXP-1)',
  ...
  // INV — Inventario
  INV1:  'No se pudo guardar. Intentá de nuevo. (INV-1)',
  ...
  INV6:  'No se pudo actualizar la lista. Intentá de nuevo. (INV-6)',
  // POS — Punto de Venta
  POS1:  'No se pudo registrar la venta. Intentá de nuevo. (POS-1)',
  POS2:  'Sin permiso para realizar ventas. (POS-2)',
  POS3:  'No se pudo identificar el negocio. Iniciá sesión nuevamente. (POS-3)',
  ...
  PRL1:  'No se pudo guardar la lista de precios. Intentá de nuevo. (PRL-1)',
  ...
  // OPR — Operarios
  OPR1:  'No se pudo guardar el operario. Intentá de nuevo. (OPR-1)',
  ...
  OPR74: 'Ocurrió un error al enviar el correo. Intentá de nuevo. (OPR-74)',
  // SET — Configuración
  SET1:  'No se pudo guardar la configuración. Intentá de nuevo. (SET-1)',
  ...
  SET6:  'No se pudo guardar el archivo. Verificá que pese menos de 2 MB e intentá de nuevo. (SET-6)',
  SET61: 'Formato no permitido. Usá JPEG, PNG, WebP o SVG. (SET-61)',
  SET62: 'El archivo supera el máximo de 2 MB. (SET-62)',
  // AUT — Autenticación
  AUT1:  'No se pudo actualizar la contraseña. Intentá de nuevo. (AUT-1)',
  ...
  // CST — Clientes
  CST1:  'No se pudo guardar el cliente. Intentá de nuevo. (CST-1)',
