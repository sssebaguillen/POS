    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md gap-0 p-0">
        <DialogHeader className="px-5 pt-5 pb-3">
          ...
          <DialogDescription>
            Reporta un bug, manda una sugerencia o cuéntanos algo que te gustaría que cambie.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col gap-3 px-5 pb-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              placeholder="Describe el problema o la sugerencia con todo el detalle que puedas…"
              rows={5}
              className={cn(
