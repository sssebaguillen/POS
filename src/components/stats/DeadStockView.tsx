...
export default function DeadStockView({ rows, summary, bucket: initialBucket, page: initialPage, pageSize }: Props) {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      <PageHeader title="Stock inmovilizado" breadcrumbs={[{ label: 'Estadísticas', href: '/stats' }]}>
