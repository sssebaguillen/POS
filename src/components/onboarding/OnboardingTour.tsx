...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    title: 'Inventario',
    description: 'Aquí gestionas productos, categorías y stock. Todo lo que vendes vive aquí.',
    placement: 'right',
    route: '/inventory',
  },
  {
    ...
    title: 'Gastos',
    description: 'Registra tus gastos operativos para tener el flujo real del negocio, no solo las ventas.',
    placement: 'right',
    route: '/expenses',
  },
  {
    target: '[data-tour="sidebar-caja"]',
    title: 'Caja',
    description: 'Abre tu caja al empezar el día y ciérrala al final. Aquí controlas el efectivo y concilias tus cuentas digitales.',
    placement: 'right',
    route: '/cash-sessions',
  },
  {
    ...
    title: 'Clientes',
    description: 'Guarda a tus clientes y véndeles a cuenta corriente (fiado). Después registras los pagos cuando salden su deuda.',
    placement: 'right',
    route: '/customers',
  },
  {
    ...
    description: 'Los pedidos de tu catálogo público llegan aquí. Los confirmas y se convierten en venta automáticamente.',
    placement: 'right',
    route: '/orders',
  },
  {
    ...
    description: 'Puedes tener múltiples listas: mayorista, minorista y promocional. Cada venta usa la lista que elijas en el momento.',
    placement: 'right',
    route: '/price-lists',
  },
  {
    ...
    title: 'Promociones',
    description: 'Crea ofertas como 2x1 o descuentos por categoría. Se aplican solas en el POS y en tu catálogo online.',
    placement: 'right',
    route: '/promotions',
  },
  {
    ...
    description: 'Desde aquí realizas las ventas. Vamos a verlo.',
    placement: 'right',
    route: '/pos',
  },
  {
    ...
    description: 'Antes de cada venta puedes elegir qué lista aplicar. Útil para atender distintos tipos de clientes.',
    placement: 'bottom',
    route: '/pos',
  },
  {
    ...
    description: 'Los productos que agregas aparecen aquí. Puedes modificar cantidades, precios y aplicar descuentos.',
    placement: 'left',
    route: '/pos',
  },
  {
    target: '[data-tour="pos-cart"]',
    title: 'Todo listo',
    description: 'Tus operarios solo verán lo que sus permisos les permitan. Si necesitas ajustar algo, está en Configuración.',
    placement: 'left',
    route: '/pos',
    isLast: true,
  },
