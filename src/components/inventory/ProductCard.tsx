        ...
        <div className="flex flex-col gap-1.5 mt-auto">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            ...
            <button
              ...
              disabled={loadingId === product.id}
              className="text-xs py-2 rounded-lg bg-destructive/10 text-destructive hover:bg-destructive/20 dark:bg-destructive/20 dark:hover:bg-destructive/30 transition-colors disabled:opacity-50 touch-manipulation"
            >
              Eliminar
            </button>
          </div>
