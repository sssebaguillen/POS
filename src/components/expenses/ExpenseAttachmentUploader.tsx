    ...
    return (
      <div className="flex items-center gap-3 rounded-xl border border-edge bg-surface-alt px-4 py-3">
        ...
        <button
          ...
          className="p-1 rounded-lg hover:bg-hover-bg transition-[transform,background-color,color] duration-150 ease-[var(--ease-out)] active:scale-95 text-hint hover:text-destructive"
        >
          <X size={16} />
        </button>
      </div>
